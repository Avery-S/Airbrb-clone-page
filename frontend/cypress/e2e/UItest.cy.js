...
describe('Admin Happy Path Test', () => {
  it('Registers successfully and logout.cy', () => {
  ...
  it('Creates a new listing successfully.cy', () => {
    ...
    cy.get('#numberOfBathrooms').clear();
    cy.get('#numberOfBathrooms').type('2');
    ...
    cy.get('#houseRules').clear();
    cy.get('#houseRules').type('This is test house rules');
  ...
  it('Updates the thumbnail and title of the listing successfully.cy', () => {
    ...
    cy.get('#title').clear();
    cy.get('#title').type('Test Hotel 4');
  ...
  it('Publish a listing successfully.cy', () => {
    ...
    cy.contains('label', 'Start date picker').parent().find('input').clear();
    cy.contains('label', 'Start date picker').parent().find('input').type('11/20/2023');
    cy.contains('label', 'End date picker').parent().find('input').clear();
    cy.contains('label', 'End date picker').parent().find('input').type('11/30/2023');
    // check date
